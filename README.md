...
<h3>I also write powershell and batch scripts to help automate these processes. See the links below to get an idea of some of the things I've accomplished with powershell and batch scripting.<h3>  
