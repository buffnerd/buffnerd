...
<h2>In my current role, I manage our SIEM, M365 Quarantine, Phishing Campaigns/Training, Endpoints, AUPs, SOPs and oversee the security of our organization  by keeping our systems both safe from exploitation and available to our users.  In the mean time, I am also writing powershell scripts to help automate these processes.  Here are a few examples of administration tasks I have simplified using Powershell and Batch scripts:<h2>
